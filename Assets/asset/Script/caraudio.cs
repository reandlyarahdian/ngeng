...
namespace UnityStandardAssets.Vehicles.Car
{
    public class caraudio : MonoBehaviour
    {
        ...
        public Rigidbody rb; // Reference to car we are controlling
        ...
        private void Update()
        {
            ...
            if (m_StartedSound)
            {
                ...
                float pitch = ULerp(lowPitchMin, lowPitchMax, rb.velocity.magnitude);
                ...
                else
                {
                    ...
                    float accFade = Mathf.Abs(rb.velocity.magnitude);
                    float decFade = 1 - accFade;

                    // get the high fade value based on the cars revs
                    float highFade = Mathf.InverseLerp(0.2f, 0.8f, rb.velocity.magnitude);
